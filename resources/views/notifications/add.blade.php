    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                ...
                <form class="card-body" method="post" enctype="multipart/form-data" action="{{route('save.notifications')}}">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="text"  class="form-control" onkeypress="limitKeypress(event,this.value,254)" required name="message" placeholder="" >
                            </div>
                        </div>
