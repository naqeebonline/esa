...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <h5 class="card-header">Add Police Line</h5>
                <form class="card-body" method="post" action="{{route('save.police.line')}}">
                    @csrf
                    <h6 class="fw-normal">1. Police Line</h6>
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text"  class="form-control" onkeypress="limitKeypress(event,this.value,100)" required name="name" placeholder="" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number"  class="form-control" onkeypress="limitKeypress(event,this.value,11)" required name="contact_number" placeholder="" >
                            </div>
                        </div>
                    ...
                    <hr class="my-4 mx-n4">
                    <h6 class="fw-normal">2. Incharge Police Post</h6>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label" for="multicol-first-name"> Name</label>
                            <input type="text" class="form-control" name="incharge_name"  onkeypress="limitKeypress(event,this.value,100)"  placeholder="ALi Khan">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label" for="multicol-first-name"> Rank</label>
                            <input type="text" class="form-control" name="incharge_rank" onkeypress="limitKeypress(event,this.value,100)"  placeholder="">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="multicol-last-name">Contact Details</label>
                            <input type="number" class="form-control"  onkeypress="limitKeypress(event,this.value,11)"  name="incharge_contact"  placeholder="">
                        </div>
