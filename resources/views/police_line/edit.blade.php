...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <h5 class="card-header">Update Police Line</h5>
                <form class="card-body" method="post" action="{{route('update.police.line')}}">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{$data->name}}" required name="name" placeholder="Name">
                        </div>
                        <div class="col-md-6">
