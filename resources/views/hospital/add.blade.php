...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <h5 class="card-header"> Add Health Facility</h5>
                <form class="card-body" method="post" action="{{route('save-hospital')}}">
                    @csrf
                    <div class="row my-3">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="number"  name="contact_number" required class="form-control" placeholder="Contact number..." >
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="text"  name="lng" id="lng"  class="form-control" placeholder="long" >
                            </div>
                        </div>
