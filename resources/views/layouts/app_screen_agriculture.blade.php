...
<body>
                ...
                <div class="app-brand demo">
                    <a href="" class="app-brand-link">
                        <span class="app-brand-text demo menu-text fw-bold ms-2">
                            <img src="{{asset('assets/site-images/agriculture_logo.png')}}" width="150">
                        </span>
                    </a>
    ...
    <script src="{{ asset('assets/js/Agriculture/farmer/laravel-file-uploader.js') }}"></script>
