...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <h5 class="card-header">Add Police Mobile</h5>
                <form class="card-body" method="post" action="{{route('save.police.mobile')}}">
                    @csrf
                        ...
                        @endif
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text"  class="form-control" onkeypress="limitKeypress(event,this.value,100)" required name="registration_number" placeholder="" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="incharge_name" onkeypress="limitKeypress(event,this.value,100)" placeholder="">
                            </div>
                            <div class="col-md-6">
...
@push('scripts')
    ...
    <script>
        ...
        $('#circle_id').on('change', function () {
            ...
            $.ajax({
                url: '{{ route("getCirclePoliceStations") }}/' + selectedCircleID, // Replace with your actual URL
                method: 'GET',
                success: function (response) {
