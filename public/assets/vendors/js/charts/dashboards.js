...
(function () {
    ...
    analyticsBarChartConfig = {
      ...
      legend: {
        ...
        markers: {
          ...
          strokeWidth: 0,
          radius: 12,
          fillColors: ['#4caf50', '#ff9800', config.colors.primary] // Define legend marker colors
        }
      },
      tooltip: {
        y: {
  ...
  if (typeof analyticsBarChartEl !== undefined && analyticsBarChartEl !== null) {
    ...
    fetch(dataUrl)
      ...
      .then(data => {
        ...
        const analyticsBarChart = new ApexCharts(analyticsBarChartEl, analyticsBarChartConfigModified);
        analyticsBarChart.render();
      })
      .catch(error => {
  ...
  if (typeof categoryBarChartEl !== undefined && categoryBarChartEl !== null) {
    ...
    fetch(dataUrl)
      ...
      .then(data => {
        ...
        const analyticsBarChart = new ApexCharts(categoryBarChartEl, categoryBarChartConfigModified);
        analyticsBarChart.render();
      })
      .catch(error => {
        console.log('Error fetching data:', error);
  ...
  if (typeof complaintAnalyticEL !== undefined && complaintAnalyticEL !== null) {
    ...
    fetch(dataUrl)
      ...
      .then(data => {
        ...
        const analyticsBarChart = new ApexCharts(complaintAnalyticEL, analyticsBarChartConfigModified);
        analyticsBarChart.render();
      })
      .catch(error => {
        console.log('Error fetching data:', error);
  ...
  const complaintCategoryBarChartEl = document.querySelector('#complaintCategoryData'),
  ...
  if (typeof complaintCategoryBarChartEl !== undefined && complaintCategoryBarChartEl !== null) {
    ...
    fetch(dataUrl)
      ...
      .then(data => {
        ...
        const analyticsBarChart = new ApexCharts(complaintCategoryBarChartEl, categoryBarChartConfigModified);
        analyticsBarChart.render();
      })
      .catch(error => {
        console.log('Error fetching data:', error);
