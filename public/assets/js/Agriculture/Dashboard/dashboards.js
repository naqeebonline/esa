  ...
  if (typeof analyticsBarChartEl !== undefined && analyticsBarChartEl !== null) {
    ...
    fetch(dataUrl)
      ...
      .then(data => {
        ...
        const analyticsBarChartConfigFarmer = {
          ...analyticsBarChartConfig,
          series: [
            data?.series?.current_year,
            data?.series?.previous_year,
          ],
          xaxis: {
        ...
        const analyticsBarChart = new ApexCharts(analyticsBarChartEl, analyticsBarChartConfigFarmer);
        analyticsBarChart.render();
      })
      .catch(error => {
